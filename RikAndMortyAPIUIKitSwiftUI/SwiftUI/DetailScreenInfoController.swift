...
struct DetailScreenInfoController: View {
    ...
    var body: some View {
        ...
        .onAppear {
            ...
            APIManager.shared.fetchCharactersModelLocation(from: character.location) { location in
                DispatchQueue.main.async {
                    switch location {
            ...
            APIManager.shared.fetchEpisodes(from: character.episode) {  fetchedEpisodes, error in
                DispatchQueue.main.async {
